...
public class ShowAllVGA {
	public List<Product> GetAllVGA(Connection Conn) throws Exception{
		List<Product> VGA = new ArrayList<Product>();
		String Query = "SELECT * FROM products_vga";
		try {
