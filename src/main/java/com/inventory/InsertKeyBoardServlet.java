...
@WebServlet("/InsertKeyBoard")
@MultipartConfig(
	    fileSizeThreshold = 1024 * 1024, // 1 MB
	    maxFileSize = 1024 * 1024 * 10, // 10 MB
	    maxRequestSize = 1024 * 1024 * 50 // 50 MB
)
public class InsertKeyBoardServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			InsertKeyBoard I = new InsertKeyBoard();
			I.Insert(Id, Name, "Image/" + Id, Type, Double.valueOf(Price) , Producer, Connect, Switch, Led, MySQLConnect.GetConnect());
