...
public class ShowAllHdd {
	public List<Product> GetAllHDD(Connection Conn) throws Exception{
		List<Product> HDD = new ArrayList<Product>();
		String Query = "SELECT * FROM products_hdd";
		try {
